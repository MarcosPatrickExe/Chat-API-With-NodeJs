...
function userData( {id, nome, CPF, senha, RG, telefone, email} : userDates){//OU: obj : userDates
    //console.log(obj) //OU:
    console.log(id, nome, CPF, senha, RG, telefone, email)//OU: (obj.id, obj.nome, obj.CPF, obj.senha, obj.RG, obj.telefone, obj.email)
}
